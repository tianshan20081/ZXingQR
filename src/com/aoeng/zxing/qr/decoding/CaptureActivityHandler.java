...
package com.aoeng.zxing.qr.decoding;
...
import com.aoeng.zxing.qr.ui.MipcaActivityCapture;
import com.aoeng.zxing.qr.ui.ScanQR2UI;
import com.aoeng.zxing.qr.view.ViewfinderResultPointCallback;
...
public final class CaptureActivityHandler extends Handler {
	...
	public CaptureActivityHandler(MipcaActivityCapture activity, Vector<BarcodeFormat> decodeFormats, String characterSet) {
		...
		decodeThread = new DecodeThread(activity, decodeFormats, characterSet, new ViewfinderResultPointCallback2(activity.getViewfinderView()));
		decodeThread.start();
		state = State.SUCCESS;
